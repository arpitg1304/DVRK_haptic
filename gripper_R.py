...
def pose():
    ...
    msg_grip = JointState()
    pub3 = rospy.Publisher('/dvrk/MTMR/state_gripper_current', JointState, queue_size=1)
    msg_grip.header.frame_id = "map"
    msg_grip.position = [0]
    msg_grip.position[0] = -0.10

    im = 0;
    pub2 = rospy.Publisher('/dvrk/MTMR/position_cartesian_current', PoseStamped, queue_size=1)
    ...
    while not rospy.is_shutdown():
        ...
        pub = rospy.Publisher('/dvrk/MTMR/status', String, queue_size=1)
        hello_str = "This"
